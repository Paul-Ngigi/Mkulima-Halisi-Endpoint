    ...
    class Meta: 
        ...
        def create(self, validated_data):
            created_product = Products.objects.create(
                ...
                product_image_1 = validated_data['product_image_1'],
                product_image_2 = validated_data['product_image_2'],
                product_image_3 = validated_data['product_image_3'],
                product_category = validated_data['product_category'],
                product_amount = validated_data['product_amount'],
                available_location = validated_data['available_location'],
